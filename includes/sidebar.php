...
<aside class="sidebar" id="sidebar">
    <nav class="sidebar-nav">
        ...
        <?php if (canManagePayments($role)): ?>
            ...
            <!-- Contact Parents section for finance staff -->
            <a href="contact_parents.php" class="nav-item <?php echo isActive('contact_parents.php'); ?>">
                <span class="nav-icon">💬</span>
                <span class="nav-text">Contact Parents</span>
            </a>
        ...
        <a href="library_books.php" class="nav-item <?php echo isActive('notes.php'); ?>">
            <span class="nav-icon">📚</span>
