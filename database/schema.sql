...
-- Add missing columns to news_posts table
ALTER TABLE news_posts ADD COLUMN title VARCHAR(255) DEFAULT '' AFTER user_id;
ALTER TABLE news_posts ADD COLUMN media_type VARCHAR(50) DEFAULT 'none' AFTER media_url;
