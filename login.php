    ...
    <div class="auth-page">
        <div class="auth-container">
            <div class="auth-card">
                ...
                <!-- Updated warning message to show specific role limits -->
                <?php if ($all_filled): ?>
                    <div class="alert alert-warning" style="background: #fff3cd; border: 1px solid #ffc107; color: #856404;">
                        <strong>Note:</strong> All administrator positions are filled:
                        <ul style="margin: 8px 0 0 20px; font-size: 13px;">
                            <li>Admin: 3 positions filled</li>
                            <li>HOI: 1 position filled</li>
                            <li>DHOI: 1 position filled</li>
                        </ul>
                        New users must be created by existing administrators.
                    </div>
                <?php endif; ?>
                ...
                <div class="demo-credentials">
                    ...
                    <?php if (!$all_filled): ?>
                        <p>Student: Full Name | student.grade.<?php echo date('Y'); ?></p>
