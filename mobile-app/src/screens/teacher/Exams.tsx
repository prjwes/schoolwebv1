...
import { View, Text, StyleSheet, ActivityIndicator, RefreshControl, Alert, FlatList } from "react-native"
...
export default function Exams() {
  ...
  const fetchExams = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/api/teacher/exams.php?user_id=${userId}`, {
